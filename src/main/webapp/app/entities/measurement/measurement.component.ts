...
export class MeasurementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.measurementService
            ...
            .subscribe(
                (res: HttpResponse<IMeasurement[]>) => this.paginateMeasurements(res.body, res.headers),
    ...
    trackId(index: number, item: IMeasurement) {
        return item.id;
    }
    ...
    private paginateMeasurements(data: IMeasurement[], headers: HttpHeaders) {
